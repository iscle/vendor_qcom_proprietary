...
RIL_NeighboringCell** ril_utf_androidTel_if::update_default_ril_request_get_neighboring_cell_ids_resp()
{
  payload = malloc_ril_request_get_neighboring_cell_ids_resp();
  payload_len = sizeof(RIL_NeighboringCell*) ;
  payload_type = ril_utf_ril_response;
  msg_id = RIL_REQUEST_GET_NEIGHBORING_CELL_IDS;
