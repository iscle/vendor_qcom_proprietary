 ...
 *--------   ---     ----------------------------------------------------------
 *02/03/16   San     Support for two new SL/SH codecs JACALA and SOUNDWIRE.
 ...
 ********************************************************************************
 */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acph/inc/acph.h#26 $ */
/*
   --------------------
   |include files                |
   --------------------
...
enum  ACPH_SERVICE_MINOR_VERSION {
   ...
   ACPH_SERVICE_MINOR_VERSION_6 = 6
};
...
//RTC command Id for RTC protocol version 1.6:
//	ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA				0x0111 // 273
//	ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA				0x0112 // 274
//	ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA					0x0113 // 275
//	ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA					0x0114 // 276
...
/** @addtogroup get_rtc_instance_cal_data
@{ */

/**
Queries for the DSP RTC instance calibration data.
...
@param[in] nCommandId Command ID is ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA.
@param[in] req_buf_ptr Input request buffer filled with the serialized
                       (little Endian) packed struct
                       ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_req.
@param[in] req_buf_len: Equals the size of ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_req.
@param[in,out] resp_buf_ptr Input buffer to be filled by the service provider
                            with the serialized (little Endian) packed struct
                            ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_rsp.
@param[in] resp_buf_len Length of the input buffer for the response data.
@param[out] resp_buf_bytes_filled Equals the size of
                                  ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_rsp + the
                                  size of uint8 * length.
...
@newpage
*/
#define ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA                  0x0111 // 273 

typedef struct ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_req ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_req;
#include "acdb_begin_pack.h"

/** Request structure for the RTC calibration data query.
*/
 struct  ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_req{
      uint32_t domain_id;     /**< Domain ID. */
      uint32_t service_id;    /**< Service ID. */
      uint32_t pp_id;         /**< COPP or POPP ID. */
      uint32_t module_id;     /**< Module ID. */
...
typedef struct ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_rsp ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_rsp;
#include "acdb_begin_pack.h"

/** Response structure for the RTC calibration data query.
*/
 struct    ACPH_CMD_RTC_GET_INSTANCE_CAL_DATA_rsp{
      uint32_t module_id;     /**< Module ID. */
	  uint16_t instance_id;	/**< Instance ID. */	
	  uint16_t reserved1;	/**< Reserced. */
      uint32_t parameter_id;  /**< Parameter ID. */
      uint32_t length;        /**< Length of the calibration data. */
      //uint8  data[<length>];
   }
...
/** @} */ /* end_addtogroup get_rtc_instance_cal_data */
                                                          //

/** @addtogroup set_rtc_instance_cal_data
@{ */

/**
Sets the DSP RTC instance calibration data.
...
@param[in] nCommandId The command ID os ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA.
@param[in] req_buf_ptr Input request buffer filled with the serialized
                       (little Endian) packed struct
                       ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA_req.
@param[in] req_buf_len Equals the size of ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA_req +
                       the size of uint8 * lengh.
@param[in,out] resp_buf_ptr Response buffer is NULL
@param[in] resp_buf_len Length of the output buffer is passed as zero.
@param[out] resp_buf_bytes_filled Valid output buffer length is returned as
...
@newpage
*/
#define ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA                  0x0112 

typedef struct ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA_req ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA_req;
#include "acdb_begin_pack.h"

/** Request structure for the Set RTC Calibration Data command.
*/
 struct  ACPH_CMD_RTC_SET_INSTANCE_CAL_DATA_req{
      uint32_t domain_id;     /**< Domain ID. */
      uint32_t service_id;    /**< Service ID. */
      uint32_t pp_id;         /**< COPP or POPP ID. */
      uint32_t module_id;     /**< Module ID. */
...
/** @} */ /* end_addtogroup set_rtc_instance_cal_data */

/** @addtogroup get_afe_instance_cal_data
@{ */

/**
Gets the AFE instance calibration data.
...
@param[in] nCommandId Command ID is ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA.
@param[in] req_buf_ptr Input request buffer filled with the serialized (little
                       ENDIAN) packed struct ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_req.
@param[in] req_buf_len Equals the size of ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_req.
@param[in,out] resp_buf_ptr Input buffer to be filled by the service provider
                            with the serialized (little ENDIAN) packed struct
                            ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_rsp.
@param[in] resp_buf_len Length of the input buffer for the response data.
@param[out] resp_buf_bytes_filled Equals the size of ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_rsp +
                                  the size of uint8 * length.
...
ACPH_CALLBACK_PTR
*/
#define ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA                  0x0113

typedef struct ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_req ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_req;
#include "acdb_begin_pack.h"

/** Request structure for the AFE instance calibration data query.
*/
 struct  ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_req{
      uint32_t afe_port_id;   /**< AFE port ID. This can be either a Tx or
                                   an Rx port ID, depending on the use case. */
      uint32_t module_id;     /**< Module ID. */
	  uint16_t instance_id;	/**< Instance ID. */	
...
typedef struct ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_rsp ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_rsp;
#include "acdb_begin_pack.h"

/** Response structure for the AFE instance calibration data query.
*/
 struct    ACPH_CMD_GET_AFE_INSTANCE_CAL_DATA_rsp{
      uint32_t module_id;     /**< Module ID. */
	  uint16_t instance_id;	/**< Instance ID. */	
	  uint16_t reserved1;	/**< Reserced. */
      uint32_t parameter_id;  /**<  Parameter ID. */
...
/** @} */ /* end_addtogroup get_afe_instance_cal_data */

/** @addtogroup set_afe_instance_cal_data
@{ */

/**
Sets the AFE insatnce calibration data.
...
@param[in] nCommandId Command ID is ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA.
@param[in] req_buf_ptr Input request buffer filled with serialized (little
                       ENDIAN) packed struct ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA_req.
@param[in] req_buf_len Equals the size of ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA_req + the
                       size of uint8 * length.
@param[in,out] resp_buf_ptr Response buffer is NULL
@param[in] resp_buf_len Length of the output buffer is passed as zero.
@param[out] resp_buf_bytes_filled Valid output buffer length is returned as
...
@newpage
*/
#define ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA                  0x0114

typedef struct ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA_req ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA_req;
#include "acdb_begin_pack.h"

/** Request structure for the set AFE calibration data command.
*/
 struct  ACPH_CMD_SET_AFE_INSTANCE_CAL_DATA_req{
	  uint32_t op_mode;           /**< Operating mode. See #Afe_Op_Mode. */
	  uint32_t tx_afe_port_id;    /**< Tx AFE port ID. Applicable if
                                       op_mode = 0 or 1. */
	  uint32_t rx_afe_port_id;    /**< Rx AFE port ID. Applicable if
...
/** @} */ /* end_addtogroup set_afe_instance_cal_data */
